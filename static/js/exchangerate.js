  ...
  const currencyNames = {
        ...
        function populateCurrencyOptions(rates) {
            ...
            currencies.forEach(currency => {
                const option1 = new Option(`${currency} - ${currencyNames[currency]}`, currency);
                const option2 = new Option(`${currency} - ${currencyNames[currency]}`, currency);
        ...
        convertButton.addEventListener('click', () => {
            ...
            if (!amount || isNaN(amount)) {
                resultDisplay.textContent = '请输入有效金额';
                return;
            }
